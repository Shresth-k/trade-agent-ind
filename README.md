...
The active roadmap is an India-first, paper-only intraday research system. See
[`docs/india-first-mvp.md`](docs/india-first-mvp.md) for the deliberately narrow
NIFTY MVP and [`docs/reference-projects.md`](docs/reference-projects.md) for the
open-source projects informing the design.
...
- **`pipeline/`** — one-shot CLIs you run before going live
  ...
  - `normalize_sources.py` — convert transcript text into an auditable JSONL corpus
